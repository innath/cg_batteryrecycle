 ...
 */
function getTenantIdForMiddleware(jwt) {
    try {
        const decodedJwt = (0, internal_1.decodedJwtOrZid)({ jwt });
        const { subdomain, zoneId } = (0, internal_1.getSubdomainAndZoneId)(decodedJwt);
...
exports.getTenantIdForMiddleware = getTenantIdForMiddleware;
