...
class DestinationFromServiceRetriever {
    ...
    getExchangeTenant(destination) {
        ...
        const subdomainSubscriber = (0, xsuaa_service_1.getSubdomainAndZoneId)(this.subscriberToken?.userJwt?.encoded).subdomain;
        const subdomainProvider = (0, xsuaa_service_1.getSubdomainAndZoneId)(this.providerServiceToken?.encoded).subdomain;
