...
export interface DestinationCacheType {
     ...
     * @internal
     */
    retrieveDestinationFromCache: (token: Required<SubscriberToken> | JwtPayload, name: string, isolation: IsolationStrategy) => Promise<Destination | undefined>;
    /**
     * @internal
     */
    cacheRetrievedDestination: (token: Required<SubscriberToken> | JwtPayload, destination: Destination, isolation: IsolationStrategy) => Promise<void>;
    /**
     * @internal
     */
    cacheRetrievedDestinations: (token: Required<SubscriberToken> | JwtPayload, retrievedDestinations: DestinationsByType, isolation: IsolationStrategy) => Promise<void>;
    /**
     * @internal
     */
    clear: () => Promise<void>;
 ...
 * @internal
 */
export declare function getDestinationCacheKey(token: SubscriberToken | JwtPayload, destinationName: string, isolationStrategy?: IsolationStrategy): string | undefined;
/**
