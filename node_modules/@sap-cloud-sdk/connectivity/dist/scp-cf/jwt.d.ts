 ...
 * @internal
 */
export declare function checkMandatoryValue<InterfaceT, JwtKeysT extends string>(key: keyof InterfaceT, mapping: JwtKeyMapping<InterfaceT, JwtKeysT>, jwtPayload: JwtPayload): void;
/**
