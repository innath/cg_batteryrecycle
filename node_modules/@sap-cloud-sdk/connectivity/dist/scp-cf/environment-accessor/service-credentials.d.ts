 ...
 */
export declare function getServiceCredentials<ServiceCredentialsT extends ServiceCredentials>(service: string, token?: JwtPayload | string): ServiceCredentialsT;
