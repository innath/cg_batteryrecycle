...
export type CustomExtension = v4.TableCustomColumn | v4.CustomAction | v4.SapUi5RoutingTargetContentSection;
 ...
 * @param sectionIdInManifest - identifier of the current object page section in manifest
 */
export declare function addCustomSubSectionDefinition(appSchema: Definition, definition: Definition, v4Page: v4.SapUiAppPageV4, facetKey: string, customSubSectionRef: string, isMergedSections: boolean, logger?: ExtensionLogger): void;
