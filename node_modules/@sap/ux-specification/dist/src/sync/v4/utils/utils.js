...
exports.addCustomSubSectionDefinition = exports.getPageCustomExtensionFile = exports.getPageCustomViewFile = exports.getManifestPage = exports.addHeaderFooterCustomActionDefinition = exports.addCustomActionDefinition = exports.alignSchemaWithTemplateType = exports.findPageV4 = exports.addEnumForActionAnchor = exports.addFragmentEnumForAnchor = exports.appendLineItemsToSchema = exports.addLineItemsTypeToSchema = exports.addCustomColumnDefinition = exports.addExtensionToArray = void 0;
...
function addActionRecordToSchema(data, actionsDefinition, lineItemPath, lineItemRecord, recordIndex, createRef = true) {
    ...
    if (lineItemRecord.Determining !== true) {
        ...
        if (createRef) {
            actionDefinition.$ref = (0, common_1.getFacetDefinitionLink)(actionDefinitionName, (0, common_1.prepareRef)(actionId));
        }
        else {
 ...
 * @param sectionIdInManifest - identifier of the current object page section in manifest
 */
function addCustomSubSectionDefinition(appSchema, definition, v4Page, facetKey, customSubSectionRef, isMergedSections, logger) {
    ...
    if (section && 'subSections' in section) {
        sortedSectionsArray = addExtensionToArray(section.subSections, sortedSectionsArray, customSubSectionRef, 'template', logger, isMergedSections);
    }
    // Adjust propertyIndex
...
exports.addCustomSubSectionDefinition = addCustomSubSectionDefinition;
